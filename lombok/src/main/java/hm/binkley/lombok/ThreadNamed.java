...
public @interface ThreadNamed {
     ...
     * parameters passed in as formatting args.  Use <em>positional
     * notation</em> to skip parameters, or they may be ignroed entirely in
     ...
     * }</pre> when called with {@code "apple", 2, 3.14159} will set the current
     * thread name to
